const dict = {
  ru: {
    ...
    no_tasks_hint: 'Добавь первую задачу выше',
    no_notes_hint: 'Нажми «+», чтобы создать',
    no_goals_hint: 'Поставь цель на этот период',
  ...
  en: {
    ...
    no_tasks_hint: 'Add your first task above',
    no_notes_hint: 'Tap “+” to create one',
    no_goals_hint: 'Set a goal for this period',
